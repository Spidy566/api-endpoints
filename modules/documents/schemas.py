...
---------------------------------------------------------------------------
Updated supported mime-types list        | 08-07-2026 | vishal
...
class DocReportImageItem(BaseModel):
...
class DocReportRequest(BaseModel):
    ...
    images: Optional[list[DocReportImageItem]] = Field(default=[], title="", description="List of images to replace placeholders in the document.")
